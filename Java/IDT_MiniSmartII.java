...
public class IDT_MiniSmartII extends IDT_Device implements ICCInterface, EMVFunctional {
	/**
	 * It is the constructor of the main class IDT_MiniSmartII. When it is
	 * called, the SDK will create the Instance for IDT_MiniSmartII device. The
	 ...
	 * 
	 */
	public IDT_MiniSmartII(OnReceiverListener callback) {
	 ...
	 * 
	 * @param deviceType  DEVICE_TYPE.DEVICE_MINISMART_II
	 * 
	 */
	public boolean device_setDeviceType(ReaderInfo.DEVICE_TYPE deviceType) {
		...
		if (deviceType == DEVICE_TYPE.IDT_DEVICE_MINISMART_II) 
			return IDTechSDKBridge.jdevicesetCurrentDevice(DEVICE_TYPE.IDT_DEVICE_MINISMART_II.getNumVal());
     ...
     * @param data Command data (if applicable) for IDG, not used for NGA
