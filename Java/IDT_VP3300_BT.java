...
public class IDT_VP3300_BT extends IDT_Device implements Configurable, MSRInterface, ICCInterface, EMVFunctional, CTLSFunctional, ThreeInterfaceDevice {
	 ...
	 * 
	 */
	public IDT_VP3300_BT(OnReceiverListener callback) {
	 ...
	 * 
	 * @param deviceType  DEVICE_TYPE.IDT_DEVICE_VP3300_BT
	 * 
	 */
	public boolean device_setDeviceType(ReaderInfo.DEVICE_TYPE deviceType) {
		if (deviceType == DEVICE_TYPE.IDT_DEVICE_VP3300_BT) {
			int rc = IDTechSDKBridge.jdeviceinit();
			if (rc != 0) return false;
			return IDTechSDKBridge.jdevicesetCurrentDevice(DEVICE_TYPE.IDT_DEVICE_VP3300_BT.getNumVal());
		}
		return false;
	}	
