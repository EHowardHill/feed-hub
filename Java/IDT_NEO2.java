...
public class IDT_NEO2 extends IDT_Device implements Configurable, MSRInterface, ICCInterface, EMVFunctional, CTLSFunctional, ThreeInterfaceDevice {
	
	/**
	 * It is the constructor of the main class IDT_NEO2. When it is
	 * called, the SDK will create the Instance for IDT_NEO2 device. The
	 ...
	 * 
	 */
	public IDT_NEO2(OnReceiverListener callback) {
	 ...
	 * 
	 * @param deviceType  DEVICE_TYPE.IDT_DEVICE_NEO2_USB
	 * 
	 */
	public boolean device_setDeviceType(ReaderInfo.DEVICE_TYPE deviceType) {
		if (deviceType == DEVICE_TYPE.IDT_DEVICE_NEO2) {
	...
	/**
	 * Initial the NEO2 Device by RS232<br/>
	 * It will try to connect to the NEO2 device with provided port_number and brate. <br/>
	...
	public int rs232_device_init(int port_number, int brate){
		ReaderInfo.DEVICE_TYPE deviceType = DEVICE_TYPE.IDT_DEVICE_NEO2_COM;
			int rc = IDTechSDKBridge.jrs232deviceinit(deviceType.getNumVal(), port_number,brate);
			return rc;
	}
